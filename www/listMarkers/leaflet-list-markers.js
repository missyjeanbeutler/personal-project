...
L.Control.ListMarkers = L.Control.extend({
	...
	_createItem: function(layer) {
		...
		L.DomEvent
			...
			// .on(a, 'click', L.DomEvent.stop, this) //this used to pan to the marker when it's name was clicked
		...
		{
			a.innerHTML = icon+'<span>'+layer.options[this.options.label]+'</span>' //<b>'+this.options.itemArrow+'</b>'; this was showing the arrow on the right of the listed trails
